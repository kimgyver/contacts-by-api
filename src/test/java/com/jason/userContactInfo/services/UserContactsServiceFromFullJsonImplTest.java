...
class UserContactsServiceFromFullJsonImplTest {
    UserContactsServiceFromFullJsonImpl userContactsService;
    ...
    @BeforeEach
    void setUp() {
        userContactsService = new UserContactsServiceFromFullJsonImpl();
    }
